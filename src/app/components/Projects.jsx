    ...
    <div>
      ...
      <div className="w-fit h-fit border-l-2 px-6 mt-8">
        <div className="flex flex-col gap-2">
          <div className="text-lg text-black">{Data.projects[0].title}</div>

          <Link
            href={Data.projects[0].link}
            target="_blank"
            className="flex gap-1 text-black hover:text-blue-700"
          >
            Live Preview
          ...
          <div className="bg-[#E4E4E7] w-fit h-fit p-2 rounded-md text-sm text-gray-800">
      ...
      <div className="w-fit h-fit border-l-2 px-6 mt-8">
        <div className="flex flex-col gap-2">
          <div className="text-lg text-black">{Data.projects[1].title}</div>
      ...
      <div className="w-fit h-fit border-l-2 px-6 mt-8">
        <div className="flex flex-col gap-2">
          <div className="text-lg text-black">{Data.projects[2].title}</div>
